...
document.write('<link href=\"css1/canvas_css.css\" rel=\"stylesheet\">');
document.write('<link href=\"css1/sp.css\" rel=\"stylesheet\">');

document.write('<link media=\"screen and (max-width: 480px)\" href=\"css1/mw480Portrait.css\" rel=\"stylesheet\">');
document.write('<link media=\"screen and (min-width: 480px) and (max-width: 1024px)\" href=\"css1/mw480Portrait.css\" rel=\"stylesheet\">');
document.write('<link media=\"screen and (min-width: 1024px)\" href=\"css1/sw1024.css\" rel=\"stylesheet\">');
...
function AnySignApi() {
	...
	*/
	...
	this.getUploadDataGram = function() {
		...
		console.log(core._getUploadDataGram)
	}
	...
	this.getVersion = function() {
		return "AnySign_V1.3.3_Web_2.3.2";
	}
...
var SignRule_KeyWord = function(keyword, keyWordAlignMethod, keyWordOffset, pageNo, KWIndex) {
	...
	if(!isNaN(pageNo) && !isNaN(keyWordOffset) && !isNaN(KWIndex)) {
		this.KWRule = {
			KW: keyword,
			KWPos: keyWordAlignMethod,
			KWOffset: keyWordOffset,
			Pageno: pageNo,
			KWIndex: KWIndex,
			XOffset: 0,
			YOffset: 0
