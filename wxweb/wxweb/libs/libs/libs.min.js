/*! by @清扬陌客 qingyangmoke@qq.com 2016-02-25 */
...
!function (a, b, c, d) {
    ...
    function z(a, b, c) {
        var d = c.pointers.length, e = c.changedPointers.length, f = b & Ab && d - e === 0,
            g = b & (Cb | Db) && d - e === 0;
    ...
    function Q(a, b) {
        ...
        if (f = c.filter(function (a) {
            return o(a.target, i)
        }), b === Ab) for (e = 0; e < f.length;) d[f[e].identifier] = !0, e++;
    ...
    var hb, ib = ["", "webkit", "Moz", "MS", "ms", "o"], jb = b.createElement("div"), kb = "function", lb = Math.round,
        mb = Math.abs, nb = Date.now;
    ...
    var ob = h(function (a, b, c) {
            ...
            return a
        }, "extend", "Use `assign`."), pb = h(function (a, b) {
            return ob(a, b, !0)
        }, "merge", "Use `assign`."), qb = 1, rb = /mobile|tablet|ip(ad|hone|od)|android/i, sb = "ontouchstart" in a,
        tb = u(a, "PointerEvent") !== d, ub = sb && rb.test(navigator.userAgent), vb = "touch", wb = "pen",
        xb = "mouse", yb = "kinect", zb = 25, Ab = 1, Bb = 2, Cb = 4, Db = 8, Eb = 1, Fb = 2, Gb = 4, Hb = 8, Ib = 16,
        Jb = Fb | Gb, Kb = Hb | Ib, Lb = Jb | Kb, Mb = ["x", "y"], Nb = ["clientX", "clientY"];
    x.prototype = {
        handler: function () {
        }, init: function () {
    ...
    var Ob = {mousedown: Ab, mousemove: Bb, mouseup: Cb}, Pb = "mousedown", Qb = "mousemove mouseup";
    i(L, x, {
        handler: function (a) {
            var b = Ob[a.type];
    ...
    var Rb = {pointerdown: Ab, pointermove: Bb, pointerup: Cb, pointercancel: Db, pointerout: Db},
        Sb = {2: vb, 3: wb, 4: xb, 5: yb}, Tb = "pointerdown", Ub = "pointermove pointerup pointercancel";
    a.MSPointerEvent && !a.PointerEvent && (Tb = "MSPointerDown", Ub = "MSPointerMove MSPointerUp MSPointerCancel"), i(M, x, {
        handler: function (a) {
            var b = this.store, c = !1, d = a.type.toLowerCase().replace("ms", ""), e = Rb[d],
                f = Sb[a.pointerType] || a.pointerType, g = f == vb, h = r(b, a.pointerId, "pointerId");
    ...
    var Vb = {touchstart: Ab, touchmove: Bb, touchend: Cb, touchcancel: Db}, Wb = "touchstart",
    ...
    i(P, x, {
        handler: function (a) {
            var b = Yb[a.type], c = Q.call(this, a, b);
            c && this.callback(this.manager, b, {pointers: c[0], changedPointers: c[1], pointerType: vb, srcEvent: a})
        }
    }), i(R, x, {
        handler: function (a, b, c) {
            var d = c.pointerType == vb, e = c.pointerType == xb;
    ...
    var $b = u(jb.style, "touchAction"), _b = $b !== d, ac = "compute", bc = "auto", cc = "manipulation", dc = "none",
        ec = "pan-x", fc = "pan-y";
    S.prototype = {
        set: function (a) {
            ...
            if (!_b) {
                ...
                var d = this.actions, e = p(d, dc), f = p(d, fc), g = p(d, ec);
                if (e) {
    ...
    var gc = 1, hc = 2, ic = 4, jc = 8, kc = jc, lc = 16, mc = 32;
    U.prototype = {
        ...
        defaults: {pointers: 1}, attrTest: function (a) {
            ...
            var b = this.state, c = a.eventType, d = b & (hc | ic), e = this.attrTest(a);
            return d && (c & Db || !e) ? b | lc : d || e ? c & Cb ? b | jc : b & hc ? b | ic : hc : mc
        }
    }), i(Z, Y, {
        defaults: {event: "pan", threshold: 10, pointers: 1, direction: Lb}, getTouchAction: function () {
        ...
        defaults: {event: "press", pointers: 1, time: 251, threshold: 9}, getTouchAction: function () {
            ...
            if (this._input = a, !d || !c || a.eventType & (Cb | Db) && !f) this.reset(); else if (a.eventType & Ab) this.reset(), this._timer = e(function () {
                this.state = kc, this.tryEmit()
            }, b.time, this); else if (a.eventType & Cb) return kc;
            return mc
        }, reset: function () {
        ...
        defaults: {event: "swipe", threshold: 10, velocity: .3, direction: Jb | Kb, pointers: 1},
        getTouchAction: function () {
        ...
        inputTarget: null,
        inputClass: null,
        preset: [[ab, {enable: !1}], [$, {enable: !1}, ["rotate"]], [bb, {direction: Jb}], [Z, {direction: Jb}, ["swipe"]], [cb], [cb, {
            event: "doubletap",
            taps: 2
        }, ["tap"]], [_]],
        cssProps: {
...
(function (e, t) {
    if (typeof module == "object" && module.exports) module.exports = t(); else if (typeof define == "function" && define.amd) define(t); else e.Spinner = t()
})(this, function () {
    "use strict";
    var e = ["webkit", "Moz", "ms", "O"], t = {}, i, o;

    function n(e, t) {
        var i = document.createElement(e || "div"), o;
        for (o in t) i[o] = t[o];
        return i
    }
    ...
    function s(e, n, r, s) {
        var a = ["opacity", n, ~~(e * 100), r, s].join("-"), l = .01 + r / s * 100,
            c = Math.max(1 - (1 - e) / n * (100 - l), e), f = i.substring(0, i.indexOf("Animation")).toLowerCase(),
            d = f && "-" + f + "-" || "";
        if (!t[a]) {
            o.insertRule("@" + d + "keyframes " + a + "{" + "0%{opacity:" + c + "}" + l + "%{opacity:" + e + "}" + (l + .01) + "%{opacity:1}" + (l + n) % 100 + "%{opacity:" + e + "}" + "100%{opacity:" + c + "}" + "}", o.cssRules.length);
            t[a] = 1
        }
        return a
    }
    ...
    c(u.prototype, {
        spin: function (e) {
            this.stop();
            var t = this, o = t.opts, r = t.el = n(null, {className: o.className});
            l(r, {position: o.position, width: 0, zIndex: o.zIndex, left: o.left, top: o.top});
            if (e) {
            ...
            t.lines(r, t.opts);
            if (!i) {
                var s = 0, a = (o.lines - 1) * (1 - o.direction) / 2, c, f = o.fps, d = f / o.speed,
                    u = (1 - o.opacity) / (d * o.trail / 100), p = d / o.lines;
                (function h() {
                    s++;
                    for (var e = 0; e < o.lines; e++) {
                        c = Math.max(1 - (s + (o.lines - e) * p) % d * u, o.opacity);
                        t.opacity(r, e * o.direction + a, c, o)
                    }
                    t.timeout = t.el && setTimeout(h, ~~(1e3 / f))
                })()
            }
            return t
        }, stop: function () {
            ...
            var o = 0, a = (t.lines - 1) * (1 - t.direction) / 2, c;
            ...
            function d(e, i) {
                return l(n(), {
                    ...
                    transform: "rotate(" + ~~(360 / t.lines * o + t.rotate) + "deg) translate(" + t.scale * t.radius + "px" + ",0)",
            ...
            for (; o < t.lines; o++) {
                c = l(n(), {
                    ...
                    opacity: t.opacity,
                    animation: i && s(t.opacity, t.trail, a + o * t.direction, t.lines) + " " + 1 / t.speed + "s linear infinite"
                });
                if (t.shadow) r(c, d("#000", "0 0 4px #000"), {top: "2px"});
                r(e, r(c, d(f(t.color, o), "")))
            }
            return e
    ...
    function p() {
        ...
        u.prototype.lines = function (t, i) {
            var o = i.scale * (i.length + i.width), n = i.scale * 2 * o;

            function s() {
                return l(e("group", {coordsize: n + " " + n, coordorigin: -o + " " + -o}), {width: n, height: n})
            }

            var a = -(i.width + i.length) * i.scale * 2 + "px", c = l(s(), {position: "absolute", top: a, left: a}), d;

            function u(t, n, a) {
                r(c, r(l(s(), {
                    rotation: 360 / i.lines * t + "deg",
                    left: ~~n
                }), r(l(e("roundrect", {arcsize: i.corners}), {
                    width: o,
                    height: i.scale * i.width,
                    left: i.scale * i.radius,
                    top: -i.scale * i.width >> 1,
                    filter: a
                }), e("fill", {color: f(i.color, t), opacity: i.opacity}), e("stroke", {opacity: 0}))))
            }

            if (i.shadow) for (d = 1; d <= i.lines; d++) {
                u(d, -2, "progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)")
            }
            for (d = 1; d <= i.lines; d++) u(d);
            return r(t, c)
        };
        u.prototype.opacity = function (e, t, i, o) {
            var n = e.firstChild;
            o = o.shadow && o.lines || 0;
            if (n && t + o < n.childNodes.length) {
                n = n.childNodes[t + o];
                n = n && n.firstChild;
                n = n && n.firstChild;
                if (n) n.opacity = i
    ...
    if (typeof document !== "undefined") {
        ...
        var h = l(n("group"), {behavior: "url(#default#VML)"});
        if (!a(h, "transform") && h.adj) p(); else i = a(h, "animation")
    }
    return u
});
/*!
